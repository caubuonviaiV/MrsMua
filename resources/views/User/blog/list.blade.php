                    ...
                    <aside class="col-lg-3">
                        <div class="widget">
                            ...
                            <ul class="comments-list">
                                ...
                                <li>
                                    <div class="alignleft">
                                        <a href="{{ 'blog/' . $new->id }}-{{ \Str::slug($new->title, '-') }}"><img src="{{ $new->thumb }}" alt=""></a>
                                    </div>
                                    <small>Category - {{ date('m.d.y', strtotime($new->created_at)) }}</small>
                                    <h3><a href="{{ 'blog/' . $new->id }}-{{ \Str::slug($new->title, '-') }}" title="">{{ $new->title }}</a></h3>
                                </li>
                                @endforeach
                            </ul>
                        </div>
                        ...
                        <!-- /widget -->
                        <div class="widget">
                            <form action="{{url('/blog/tim-kiem')}}" method="GET">
                                <div class="search-box">
                                    <input type="text" name="tukhoa" class="search-input" placeholder="Nhập từ khóa tìm kiếm...">
