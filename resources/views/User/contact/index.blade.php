            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4">
                    <div class="box_contacts">
                        ...
                        <small>- <a href="reservations.html">Hoặc sử dụng biểu mẫu trực tuyến</a> -</small>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="box_contacts">
                        ...
                        <small>- <a href="#0">Nhận chỉ đường</a> -</small>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="box_contacts">
            ...
            <div class="col-lg-4 col-md-6 add_bottom_25">
                ...
                <form method="post" action="">
                   @csrf
                    ...
                    <div class="form-group">
                        <textarea class="form-control" style="height: 150px;" placeholder="Nội dung tin nhắn" name="content"></textarea>
                    </div>
                    <div class="form-group">
